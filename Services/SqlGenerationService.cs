...
public class SqlGenerationService
{
        ...
        string application)
    {
        ...
        var header = BuildProcedureHeader(
            "GetByAttributes",
            $"{tableName}{DatabaseConstants.GetByAttributesProcedureSuffix}",
            $"Get {tableName} records by attributes",
            database,
            application,
            initials,
            storyNumber,
    ...
    private string BuildProcedureHeader(
